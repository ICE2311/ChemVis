...
const NeonExplorationPage = () => {
    ...
    const element = {
        ...
        group: 18,
        period: 2,
        image: "https://images.unsplash.com/photo-1597988881464-d6145be36505?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDE1fHxuZW9ufGVufDB8fHx8MTY0OTk2OTM2MQ&ixlib=rb-1.2.1&q=80&w=400",
        properties: [
            { name: "Physical Properties", value: "Neon is a colorless, odorless gas." },
            { name: "Chemical Properties", value: "Neon is inert and does not react with other elements." }
        ],
        uses: [
            { value: "Used in neon signs and high-voltage indicators." },
            { value: "Utilized in gas lasers." },
            { value: "Serves as a cryogenic refrigerant." }
        ],
        isotopes: [
            { name: "Neon-20", value: "The most abundant stable isotope of Neon." }
        ],
        funFacts: [
            "Neon was discovered in 1898 by Sir William Ramsay and Morris Travers.",
            "It glows a bright reddish-orange color when electrified.",
            "Neon makes up about 0.0018% of the Earth's atmosphere."
        ],
        quizQuestions: [
            { question: "What is the atomic number of Neon?", options: ["8", "9", "10", "11"], correctAnswer: 2 },
            { question: "In which group is Neon located?", options: ["17", "18", "16", "14"], correctAnswer: 1 },
            { question: "What color does Neon emit when electrified?", options: ["Blue", "Green", "Reddish-Orange", "White"], correctAnswer: 2 }
        ]
    };
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="bg-gray-200 rounded-lg flex items-center justify-center" style={{ height: '50vh' }} >
                        <model-viewer
                            src="/elements/neon.glb" // Ensure the correct path to your model
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="bg-gray-200 rounded-lg flex items-center justify-center" style={{ height: '560px' }} >
                        <iframe width="315" height="560"
                            src="https://www.youtube.com/embed/AbRttpC8_RU?feature=share"
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div>
                        ...
                        <div className="bg-gray-100 p-4 rounded-lg mb-4">
                            ...
                            <p>Neon lights are mesmerizing!</p>
                        </div>
                        <div className="bg-gray-100 p-4 rounded-lg">
                            <p className="font-semibold">John Doe</p>
                            <p>Did you know neon signs were first created in 1910?</p>
                        </div>
                    </div>
                </div>
            </div>
...
export default NeonExplorationPage;
