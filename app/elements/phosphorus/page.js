...
const PhosphorusExplorationPage = () => {
    ...
    const element = {
        ...
        group: 15,
        period: 3,
        image: "https://images.unsplash.com/photo-1561604169-df6b1d021e1b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDR8fHBob3NwaG9ydXN8ZW58MHx8fHwxNjQ5OTc0MjY3&ixlib=rb-1.2.1&q=80&w=400",
        properties: [
            { name: "Physical Properties", value: "Phosphorus is a non-metal and exists in several allotropic forms." },
            { name: "Chemical Properties", value: "It is highly reactive and forms compounds with many elements." }
        ],
        uses: [
            { value: "Essential for plant growth; found in fertilizers." },
            { value: "Used in the production of phosphoric acid." },
            { value: "Important in the production of safety matches." }
        ],
        isotopes: [
            { name: "Phosphorus-31", value: "The most stable and abundant isotope of phosphorus." }
        ],
        funFacts: [
            "Phosphorus was discovered in 1669 by Hennig Brand.",
            "It is an essential element for life and is a key component of DNA and RNA.",
            "Phosphorus glows in the dark when exposed to oxygen."
        ],
        quizQuestions: [
            { question: "What is the atomic number of Phosphorus?", options: ["13", "14", "15", "16"], correctAnswer: 2 },
            { question: "In which group is Phosphorus located?", options: ["14", "15", "16", "17"], correctAnswer: 1 },
            { question: "What is a common use for Phosphorus?", options: ["Electronics", "Fertilizers", "Construction", "Food processing"], correctAnswer: 1 }
        ]
    };
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="bg-gray-200 h-96 rounded-lg flex items-center justify-center">
                        <iframe
                            ...
                            title="Phosphorus Molecule"
                            frameBorder="0"
                            allowFullScreen
                            src="https://sketchfab.com/models/9f2ed8d5c2d14c65a013fffeac58d89b/embed?autospin=1&autostart=1&preload=1">
                        </iframe>
                    </div>
                </div>
            </div>
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="mb-8">
                        ...
                        <textarea
                            ...
                            rows="4"
                            placeholder="Share your experiences with Phosphorus..."
                        ></textarea>
                    ...
                    <div>
                        ...
                        <div className="bg-gray-100 p-4 rounded-lg mb-4">
                            ...
                            <p>Phosphorus is essential for life!</p>
                        </div>
...
export default PhosphorusExplorationPage;
