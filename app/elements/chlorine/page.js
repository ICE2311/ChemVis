...
const ChlorineExplorationPage = () => {
    ...
    const element = {
        ...
        group: 17,
        period: 3,
        image: "https://images.unsplash.com/photo-1598462941965-2ab7b07f1e30?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDJ8fGNobG9yaW5lfGVufDB8fHwxNjQ5OTc0NjY2&ixlib=rb-1.2.1&q=80&w=400",
        properties: [
            { name: "Physical Properties", value: "Chlorine is a greenish-yellow gas at room temperature." },
            { name: "Chemical Properties", value: "It is highly reactive and is used in many chemical reactions." }
        ],
        uses: [
            { value: "Commonly used in disinfectants and bleach." },
            { value: "Essential for the production of PVC and other plastics." },
            { value: "Used in water treatment to kill bacteria." }
        ],
        isotopes: [
            { name: "Chlorine-35", value: "The most abundant isotope of chlorine." },
            { name: "Chlorine-37", value: "Another stable isotope of chlorine." }
        ],
        funFacts: [
        ...
        quizQuestions: [
            { question: "What is the atomic number of Chlorine?", options: ["16", "17", "18", "19"], correctAnswer: 1 },
            { question: "In which group is Chlorine located?", options: ["16", "17", "18", "19"], correctAnswer: 0 },
            { question: "What is a common use for Chlorine?", options: ["Fertilizers", "Water treatment", "Electronics", "Food processing"], correctAnswer: 1 }
        ]
    };
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="bg-white rounded-lg shadow-lg p-6 flex flex-col md:flex-row">
                    <div className="md:w-1/3 mb-6 md:mb-0">
                        <Image
                            src="/elementimage/image copy 6.png"
                            alt={element.name}
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="mb-8">
                        ...
                        <textarea
                            ...
                            rows="4"
                            placeholder="Share your experiences with Chlorine..."
                        ></textarea>
                    ...
                    <div>
                        ...
                        <div className="bg-gray-100 p-4 rounded-lg mb-4">
                            ...
                            <p>Chlorine is a powerful disinfectant!</p>
                        </div>
                        <div className="bg-gray-100 p-4 rounded-lg">
                            <p className="font-semibold">John Doe</p>
                            <p>I learned a lot about its industrial uses!</p>
                        </div>
                    </div>
                </div>
            </div>
...
export default ChlorineExplorationPage;
