...
const HeliumExplorationPage = () => {
    ...
    const element = {
        ...
        group: 18,
        period: 1,
        image: "https://media.istockphoto.com/id/531069788/photo/row-of-liquefied-helium-industrial-gas-containers.jpg?s=612x612&w=0&k=20&c=9fQ-Aw3EtVUYe6o-sl61eH8b0U-Lo4VzUVM8CHo6X5I=",
        properties: [
            { name: "Physical Properties", value: "Helium is a colorless, odorless, tasteless, non-toxic gas that is lighter than air." },
            { name: "Chemical Properties", value: "Helium is a noble gas and is chemically inert, meaning it does not easily form compounds." }
        ],
        uses: [
            { value: "Used in balloons and airships as a safer alternative to hydrogen." },
            { value: "Cooling medium for MRI machines and other cryogenic applications." }
        ],
        isotopes: [
            { name: "Helium-3", value: "A rare, stable isotope with two protons and one neutron." },
            { name: "Helium-4", value: "The most abundant isotope with two protons and two neutrons." }
        ],
        funFacts: [
            "Helium was first discovered in the spectrum of the Sun.",
            "It is the second most abundant element in the observable universe.",
            "Helium is used in deep-sea diving to prevent nitrogen narcosis.",
            "It can be used to cool superconducting magnets."
        ],
        quizQuestions: [
            { question: "What is the atomic number of Helium?", options: ["1", "2", "3", "4"], correctAnswer: 1 },
            { question: "Which isotope of Helium is used in cryogenics?", options: ["Helium-3", "Helium-4", "Hydrogen-1", "Oxygen-16"], correctAnswer: 0 },
            { question: "What is a common use of Helium?", options: ["Fuel for rockets", "Filling balloons", "Electronics", "Nuclear power"], correctAnswer: 1 }
        ]
    };
        ...
        <div className="bg-gray-100 min-h-screen">
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="bg-gray-200 rounded-lg flex items-center justify-center" style={{ height: '50vh' }} >                        <model-viewer
                        src="/elements/helium.glb" // Ensure the correct path to your model
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="bg-gray-200 rounded-lg flex items-center justify-center" style={{ height: '560px' }} >
                        <iframe width="315" height="560"
                            src="https://www.youtube.com/embed/44Bs5pJPD8Q"
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div>
                        ...
                        <div className="bg-gray-100 p-4 rounded-lg mb-4">
                            ...
                            <p>Helium is fascinating! I love using it in my experiments.</p>
                        </div>
...
export default HeliumExplorationPage;
