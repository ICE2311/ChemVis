...
const BoronExplorationPage = () => {
    ...
    const element = {
        ...
        uses: [
            { value: "Used in glass and ceramics to improve thermal and chemical resistance." },
            { value: "Essential for plant growth as a micronutrient." }
        ],
        isotopes: [
            { name: "Boron-10", value: "A stable isotope used in nuclear applications." },
            { name: "Boron-11", value: "The most abundant isotope, making up about 80% of natural boron." }
        ],
        funFacts: [
            "Boron is not found in nature as a free element; it occurs only in compounds.",
            "It was discovered in 1808 by Sir Humphry Davy.",
            "Boron compounds are used in detergents to enhance cleaning power.",
            "Boron is a key component in borosilicate glass, known for its durability."
        ],
        quizQuestions: [
            { question: "What is the atomic number of Boron?", options: ["4", "5", "6", "7"], correctAnswer: 1 },
            { question: "Which property is true about Boron?", options: ["It is a gas at room temperature", "It is a metalloid", "Highly soluble in water", "Non-toxic"], correctAnswer: 1 },
            { question: "What is a common use of Boron?", options: ["Fuel", "Glassmaking", "Cooking", "Batteries"], correctAnswer: 1 }
        ]
    };
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="bg-gray-200 rounded-lg flex items-center justify-center" style={{ height: '50vh' }} >
                        <model-viewer
                            src="/elements/boron.glb" // Ensure the correct path to your model
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="bg-gray-200 rounded-lg flex items-center justify-center" style={{ height: '560px' }} >
                        <iframe width="315" height="560"
                            src="https://www.youtube.com/embed/rK-VVTIcGYU" title="YouTube video player"
                            frameborder="0"
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div>
                        ...
                        <div className="bg-gray-100 p-4 rounded-lg mb-4">
                            ...
                            <p>Boron is essential for healthy plant growth!</p>
                        </div>
                        <div className="bg-gray-100 p-4 rounded-lg">
                            <p className="font-semibold">John Doe</p>
                            <p>Borosilicate glass is amazing for kitchenware!</p>
                        </div>
                    </div>
                </div>
            </div>
...
export default BoronExplorationPage;
