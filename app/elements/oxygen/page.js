...
const OxygenExplorationPage = () => {
    ...
    const element = {
        ...
        group: 16,
        period: 2,
        image: "https://images.unsplash.com/photo-1588348838186-89c8b1521916?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDd8fG9neHN2b2x0ZWF8ZW58MHx8fHwxNjQ5OTY5MzA3&ixlib=rb-1.2.1&q=80&w=400",
        properties: [
            { name: "Physical Properties", value: "Oxygen is a colorless, odorless gas at room temperature." },
            { name: "Chemical Properties", value: "Oxygen is highly reactive and supports combustion." }
        ],
        uses: [
            { value: "Essential for respiration in most living organisms." },
            { value: "Used in medical applications for oxygen therapy." },
            { value: "Commonly used in welding and metal cutting." }
        ],
        isotopes: [
            { name: "Oxygen-16", value: "The most abundant isotope, constituting about 99.76% of oxygen." },
            { name: "Oxygen-17", value: "A stable isotope used in various scientific applications." },
            { name: "Oxygen-18", value: "Used in paleoclimatology to study historical climate changes." }
        ],
        funFacts: [
            "Oxygen makes up about 21% of the Earth's atmosphere.",
            "The name 'oxygen' comes from the Greek words 'oxy' and 'genes,' meaning 'acid-forming.'",
            "Liquid oxygen is pale blue and is used as a propellant in rockets.",
            "Oxygen is a key component of water, which is essential for life."
        ],
        quizQuestions: [
            { question: "What is the atomic number of Oxygen?", options: ["6", "7", "8", "9"], correctAnswer: 2 },
            { question: "What percentage of the Earth's atmosphere is Oxygen?", options: ["21%", "25%", "50%", "78%"], correctAnswer: 0 },
            { question: "Which isotope of Oxygen is most abundant?", options: ["Oxygen-15", "Oxygen-16", "Oxygen-17", "Oxygen-18"], correctAnswer: 1 }
        ]
    };
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="bg-gray-200 rounded-lg flex items-center justify-center" style={{ height: '50vh' }} >
                        <model-viewer
                            src="/elements/oxygen.glb" // Ensure the correct path to your model
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div className="bg-gray-200 rounded-lg flex items-center justify-center" style={{ height: '560px' }} >
                        <iframe width="315" height="560"
                            src="https://www.youtube.com/embed/uDnKp0TyUP8?feature=share"
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div>
                        ...
                        <div className="bg-gray-100 p-4 rounded-lg mb-4">
                            ...
                            <p>Oxygen is essential for breathing!</p>
                        </div>
                        <div className="bg-gray-100 p-4 rounded-lg">
                            <p className="font-semibold">John Doe</p>
                            <p>Did you know liquid oxygen is used in rocket fuel?</p>
                        </div>
                    </div>
                </div>
            </div>
...
export default OxygenExplorationPage;
